...
#SBATCH --time=2-11:00            # Runtime in D-HH:MM
...
#python3 sequential_inference_17params.py 10000 1000 64 10000_sims_17_fake_obs_stop2 1
python3 sequential_inference_allparams.py 10000 100 64 10000_sims_25_fake_obs_3_steps_time_ratio_again 1
...
#python3 ERP_sim_inf_multi_round.py 10000 nsf 64 1000 25 
