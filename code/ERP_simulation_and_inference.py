...
def main(argv):
    ...
    if (
        num_params == 7
    ):  # for a start, this would look for all weights of the distal drive
        ...
        prior_min = [
            ...
            0.000,
            43.821,
        ]  # ampa: 'L2_basket''L2_pyramidal', 'L5_pyramidal', NMDA: 'L2_basket,'L2_pyramidal','L5_pyramidal'
    ...
    file_writer = write_to_file.WriteToFile(
        experiment="ERP_save_sim_{}_num_params:{}_".format(
